...
sub tlds          { return qw/cc tv name xn--pssy2u xn--c1yn36f xn--11b4c3d xn--t60b56a xn--c2br7g xn--42c2d9a xn--j1aef xn--3pxu8k xn--hdb9cza1b xn--mk1bu44c xn--fhbei xn--tckwe xn--9dbq2a azure bing crs hotmail java maif microsoft oracle pictet sca shell sky xbox windows/; } ## If this changes, VeriSign/NameStore will need to be updated also
sub object_types  { return qw/domain ns registry/; }

sub transport_protocol_default
{
 my ($self,$type)=@_;
 return ('Net::DRI::Transport::Socket',{remote_host=>'ote-ctldepp.verisign-grs.com', remote_port=>700},'Net::DRI::Protocol::EPP::Extensions::VeriSign::Platforms::NameStore',{'fee_version' => '1.0'}) if $type eq 'epp';
